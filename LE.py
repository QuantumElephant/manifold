...
points=5000
for j in range(4,30):
    LEoutput = manifold.SpectralEmbedding(n_components=3,n_neighbors=j).fit_transform(co_internal)
    print("standrd ok")
    ...
    plt.savefig("/home/sky8/structure/Internal_LE_1_15_neighbor%d.png" % j ,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_2_25, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_LE_2_25_neighbor%d.png" % j ,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_16_39, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_LE_16_39_neighbor%d.png" % j ,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_51_92, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_LE_51_92_neighbor%d.png" % j ,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_61_86, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_LE_61_86_neighbor%d.png" % j ,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),divergence, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_LE_convergence_neighbor%d.png" % j ,dpi=600)
