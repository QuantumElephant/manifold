...
for j in range(4,30):
    ...
    plt.savefig("/home/sky8/structure/Internal_isomap_1_15_neighbor%d.png" % j,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_2_25, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_isomap_2_25_neighbor%d.png" % j,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_16_39, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_isomap_16_39_neighbor%d.png" % j,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_51_92, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_isomap_51_92_neighbor%d.png" % j,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),F_lis_61_86, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_isomap_61_86_neighbor%d.png" % j,dpi=600)

    fig = plt.figure()
    plt.scatter( list(range(100,points,10)),divergence, s=1, alpha=0.5,figure = fig)
    plt.savefig("/home/sky8/structure/Internal_isomap_convergence_neighbor%d.png" % j,dpi=600)
